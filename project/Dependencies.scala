...
object Dependencies {
  ...
  val grpcCensus          = "io.grpc"                     % "grpc-census"               % scalapb.compiler.Version.grpcJavaVersion % "runtime"
  val openCensus          = "io.opencensus"               % "opencensus-impl"           % "0.24.0"                                 % "runtime"
  val nettyBoringSsl      = "io.netty"                    % "netty-tcnative-boringssl-static" % "2.0.62.Final"
  val nettyTcnative       = "io.netty"                    % "netty-tcnative"            % "2.0.62.Final" classifier osClassifier
  val nettyTcnativeLinux  = "io.netty"                    % "netty-tcnative"            % "2.0.62.Final" classifier "linux-x86_64"
  val nettyTcnativeFedora = "io.netty"                    % "netty-tcnative"            % "2.0.62.Final" classifier "linux-x86_64-fedora"
  val perfmark6           = "io.perfmark"                 % "perfmark-java6"            % "0.19.0"
  val perfmark7           = "io.perfmark"                 % "perfmark-java7"            % "0.19.0"
  val perfmark9           = "io.perfmark"                 % "perfmark-java9"            % "0.19.0"
  ...
  val bitcoin_s           = "org.bitcoin-s"              %% "bitcoin-s-crypto"          % "1.9.3"
